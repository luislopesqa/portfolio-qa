...
A autenticação só será considerada válida se o par e-mail/senha corresponder exatamente ao cadastro existente.

O sistema não deve informar qual campo (e-mail ou senha) está incorreto, para evitar vazamento de informações sobre contas existentes.
